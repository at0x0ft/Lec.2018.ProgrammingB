...
typedef unsigned char array[MAX_N][MAX_N];
    ...
    for (i = 0; i < n; ) {
      ...
      for (j1 = j; j1 < j1_Lim; j1++) {
        ...
        for (i1 = i; i1 < i1_Lim; i1+=4) {
          ...
          dst[dr][i1+2] = src[i1+2][j1];
          dst[dr][i1+3] = src[i1+3][j1];
          dst[dr][i1+4] = src[i1+4][j1];
          dst[dr][i1+5] = src[i1+5][j1];
          dst[dr][i1+6] = src[i1+6][j1];
          dst[dr][i1+7] = src[i1+7][j1];
        }
      }
      i = i1_Lim;
    }
